...
namespace glutils {
	...
	void drawPolygon(const std::vector<glm::dvec2>& points, const glm::vec4& color, const std::vector<glm::dvec2>& texCoords, const glm::mat4& mat, std::vector<Vertex>& vertices, bool flip = false);
	...
	void drawConcavePolygon(const std::vector<glm::dvec2>& points, const glm::vec4& color, const std::vector<glm::dvec2>& tex_coords, const glm::mat4& mat, std::vector<Vertex>& vertices, bool flip = false);
	void drawConcavePolygon(const std::vector<glm::dvec2>& points, const std::vector<std::vector<glm::dvec2>>& holes, const glm::vec4& color, const std::vector<glm::dvec2>& tex_coords, const std::vector<std::vector<glm::dvec2>>& holes_tex_coords, const glm::mat4& mat, std::vector<Vertex>& vertices, bool flip = false);
	...
	void drawPrism(std::vector<glm::vec2> bottom_points, std::vector<glm::vec2> top_points, double h, const glm::vec4& color, const glm::mat4& mat, std::vector<Vertex>& vertices);
