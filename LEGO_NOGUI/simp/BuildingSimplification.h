...
namespace simp {
	...
	private:
		...
		static std::shared_ptr<util::BuildingLayer> regularizerBuilding(std::shared_ptr<util::BuildingLayer> layer, std::vector<regularizer::Config>& regularizer_configs);
	};
