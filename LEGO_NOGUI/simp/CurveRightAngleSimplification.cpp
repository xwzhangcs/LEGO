...
namespace simp {
	...
	*/
	util::Polygon CurveRightAngleSimplification::simplify(const util::Polygon& polygon, float epsilon, float curve_threshold) {
		util::Polygon ans;
	...
	void CurveRightAngleSimplification::decomposePolygon(util::Polygon input, util::Polygon& polygon, float epsilon, float curve_threshold) {
	...
	*/
	std::vector<util::Polygon> CurveRightAngleSimplification::findContours(const cv::Mat_<uchar>& img, float epsilon, float curve_threshold) {
	...
	*/
	bool CurveRightAngleSimplification::approxContour(std::vector<cv::Point2f>& input, util::Polygon &output, float epsilon, float curve_threshold){
