...
def data_shuffle(src_path, src_csv, output_path):
	...
	for key, value in src_dic.items():
		...
		if 0 <= index < train:
			...
			output_img = grammar_dir_train + '/facade_' + format(train_index, '05d') + '.png'
			...
			output_img = grammar_dir_val + '/facade_' + format(val_index, '05d') + '.png'
			cv2.imwrite(output_img, src_img)
			...
			output_img = grammar_dir_test + '/facade_' + format(test_index, '05d') + '.png'
			cv2.imwrite(output_img, src_img)
